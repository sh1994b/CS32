...
//counts how many flatulans are at a point of (r,c)
...
void City::preachToFlatulansAroundPlayer()
{
	...
	for (int k = 0; k < m_nFlatulans; )
	{
		...
		bool conversion = fp->possiblyGetConverted();

		//if the flatulan doesn't convert call the record function of History
